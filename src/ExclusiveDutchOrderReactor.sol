...
import {SignedOrder, ResolvedOrder, OrderInfo} from "@uniswap/uniswapx/base/ReactorStructs.sol";
...
contract ExclusiveDutchOrderReactor is BaseReactor {
    ...
    constructor(address _mailbox, address _igp, IPermit2 _permit2, address _protocolFeeOwner) BaseReactor(_mailbox, _igp, _permit2, _protocolFeeOwner) {}
